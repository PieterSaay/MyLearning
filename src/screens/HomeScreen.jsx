  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      <main className="flex-1 px-4 pb-8">
        <h2 className="text-center text-xl font-bold text-gray-700 mb-5 mt-2">In watter graad is jy?</h2>
          ...
          {GRADES.map(grade => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-xl font-extrabold ${c.text}`}>Graad {grade}</span>
              </button>
            )
          })}
        </div>
        ...
        <div className="mt-8 text-center">
          <span className="inline-flex items-center gap-2 text-sm text-gray-500 bg-white/70 px-4 py-2 rounded-full shadow-sm">
            <span className="text-green-500 font-bold">●</span> Werk sonder internet · Aangedryf deur CAPS kurrikulum
          </span>
        </div>
      </main>
    </div>
